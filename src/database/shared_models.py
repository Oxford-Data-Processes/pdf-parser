...
class IncomeSubcategory(TransactionSubcategory, str, Enum):
...
class TransferInSubcategory(TransactionSubcategory, str, Enum):
...
class TransferOutSubcategory(TransactionSubcategory, str, Enum):
...
class LoanPaymentsSubcategory(TransactionSubcategory, str, Enum):
...
class BankFeesSubcategory(TransactionSubcategory, str, Enum):
...
class EntertainmentSubcategory(TransactionSubcategory, str, Enum):
...
class FoodAndDrinkSubcategory(TransactionSubcategory, str, Enum):
...
class GeneralMerchandiseSubcategory(TransactionSubcategory, str, Enum):
...
class HomeImprovementSubcategory(TransactionSubcategory, str, Enum):
...
class MedicalSubcategory(str, Enum):
...
class GeneralServicesSubcategory(str, Enum):
...
class GovernmentAndNonProfitSubcategory(str, Enum):
...
class RentAndUtilitiesSubcategory(str, Enum):

...
class PDFCoordinateFinder:
    ...
    def load_page(self):
        ...
        self.ax.set_title(f'Page {self.current_page + 1} of {len(self.doc)}\n'
            ...
            if self.mode == 'pan':
                ...
                if self.first_point is None:
                    ...
                    self.first_point_marker = self.ax.plot(
                        event.xdata, event.ydata, 'ro', markersize=5)[0]
    ...
    def show_coordinates(self, event):
        ...
        try:
            ...
            self.ax.set_xlim(x - self.page_width * 0.1, x + width + self.page_width * 0.1)
            self.ax.set_ylim(y - self.page_height * 0.1, y + height + self.page_height * 0.1)
